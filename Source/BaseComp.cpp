        ...
        s(MemoryBlock(BinaryData::trans_cn, BinaryData::trans_cnSize).toString())
{
    ...
    infoLb->setText("0 : 0", dontSendNotification);
...
{    
    infoLb->setText(chessboard->getInfo(), dontSendNotification);
}
//==========================================================================
...
{
    // timeout combobox...
    timeSetCb->clear(sendNotification);
    timeSetCb->addItem(TRANS("Unlimited"), 1);
    timeSetCb->addSeparator();
    ...
    // steps combobox...
    roundSetCb->clear(sendNotification);
    roundSetCb->addItem(TRANS("Unlimited"), 1);
    roundSetCb->addSeparator();
    ...
    // labels..
    timeSetLb->setText(TRANS("Timeout: "), dontSendNotification);
    roundSetLb->setText(TRANS("Limit step: "), dontSendNotification);
